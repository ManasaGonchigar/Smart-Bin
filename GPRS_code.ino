...
void loop(){
    ...
    if (1)
    {
        ...
        {
            // Sets url 
            answer = sendATcommand("AT+HTTPPARA=\"URL\",\"http://api.pushingbox.com/pushingbox?devid=v80C103431F21BE8&tempData=1234\"", "OK", 5000);
            if (answer == 1)
            {
                // Starts GET action
                ...
                if (answer == 1)
                {
                    ...
                    do{
                        ...
                        if (sendATcommand2(aux_str, "+HTTPREAD:", "ERROR", 30000) == 1)
                        {
                            ...
                            if (data_size > 0)
                            {
                                while(mySerial.available() < data_size);
                                mySerial.read();
